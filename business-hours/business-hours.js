...
},{"../core-js/object/assign":"h2Mz"}],"htFH":[function(require,module,exports) {
...
},{"./_object-pie":"z7R8","./_property-desc":"0WCH","./_to-iobject":"Wyka","./_to-primitive":"EKwp","./_has":"yS17","./_ie8-dom-define":"R6c1","./_descriptors":"6MLN"}],"cOHw":[function(require,module,exports) {
...
},{"core-js/library/fn/object/get-own-property-symbols":"4hqW"}],"PDcB":[function(require,module,exports) {
...
},{"core-js/library/fn/object/keys":"eOjq"}],"gxIt":[function(require,module,exports) {
...
},{"../core-js/object/get-own-property-descriptor":"mQ9c","../core-js/object/get-own-property-symbols":"DovH","../core-js/object/keys":"1d81","./defineProperty":"n5FU"}],"uGcB":[function(require,module,exports) {
"use strict";var e=a(require("@babel/runtime-corejs2/helpers/extends")),t=a(require("@babel/runtime-corejs2/helpers/defineProperty")),n=a(require("@babel/runtime-corejs2/helpers/objectSpread"));function a(e){return e&&e.__esModule?e:{default:e}}var l=wp.element,r=l.Fragment,c=l.createElement,o=wp.components.TextControl,s=wp.blocks.registerBlockType,u=wp.i18n.__,i=function(e){var a=e.day,l=e.hours,c=e.setAttributes,s=e.resetFocus;return React.createElement(r,null,React.createElement("dt",null,a),React.createElement("dd",null,React.createElement(o,{type:"time",label:u("Opening","random-blocks"),value:l[a].opening,onChange:function(e){s&&s(),c({hours:(0,n.default)({},l,(0,t.default)({},a,(0,n.default)({},l[a],{opening:e})))})}})," — ",React.createElement(o,{type:"time",label:u("Closing","random-blocks"),value:l[a].closing,onChange:function(e){s&&s(),c({hours:(0,n.default)({},l,(0,t.default)({},a,(0,n.default)({},l[a],{closing:e})))})}})))},d=function(t){return React.createElement("dl",{className:"business-hours"},React.createElement(i,(0,e.default)({day:"Sun"},t)),React.createElement(i,(0,e.default)({day:"Mon"},t)),React.createElement(i,(0,e.default)({day:"Tue"},t)),React.createElement(i,(0,e.default)({day:"Wed"},t)),React.createElement(i,(0,e.default)({day:"Thu"},t)),React.createElement(i,(0,e.default)({day:"Fri"},t)),React.createElement(i,(0,e.default)({day:"Sat"},t)))};s("random-blocks/business-hours",{title:u("Business Hours","random-blocks"),icon:React.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24"},React.createElement("path",{fill:"none",d:"M0 0h24v24H0V0z"}),React.createElement("path",{d:"M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"})),category:"widgets",supports:{html:!0},attributes:{hours:{type:"object",default:{Sun:{opening:"",closing:""},Mon:{opening:"8:00",closing:"5:00"},Tue:{opening:"",closing:""},Wed:{opening:"",closing:""},Thu:{opening:"",closing:""},Fri:{opening:"",closing:""},Sat:{opening:"",closing:""}}}},edit:function(e){return React.createElement(d,{hours:e.attributes.hours,setAttributes:e.setAttributes})},save:function(){return null}});
},{"@babel/runtime-corejs2/helpers/extends":"5Il/","@babel/runtime-corejs2/helpers/defineProperty":"n5FU","@babel/runtime-corejs2/helpers/objectSpread":"gxIt"}]},{},["uGcB"], null)
