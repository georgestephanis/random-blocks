...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=s(require("@babel/runtime-corejs2/helpers/extends")),t=s(require("@babel/runtime-corejs2/core-js/object/keys")),r=s(require("./HoursRow"));function s(e){return e&&e.__esModule?e:{default:e}}var u=businessHours,a=u.start_of_week,o=function(s){return React.createElement("dl",{className:"business-hours "+(s.edit?"edit":"")},(0,t.default)(s.hours).concat((0,t.default)(s.hours).slice(0,a)).slice(a).map(function(t){return React.createElement(r.default,(0,e.default)({day:t},s))}))},l=o;exports.default=l;
